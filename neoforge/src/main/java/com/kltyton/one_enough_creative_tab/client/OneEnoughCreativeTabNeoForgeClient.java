...
public final class OneEnoughCreativeTabNeoForgeClient {
    private OneEnoughCreativeTabNeoForgeClient() {
    }

    /** Registers client payload handlers and the client-to-server transport bridge. */
    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(OneEnoughCreativeTabNeoForgeClient::registerPayloadHandlers);
        NeoForge.EVENT_BUS.addListener(OneEnoughCreativeTabNeoForgeClient::loggingOut);
