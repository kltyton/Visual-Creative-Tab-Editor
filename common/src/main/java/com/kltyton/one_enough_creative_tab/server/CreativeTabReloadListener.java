...
import com.kltyton.one_enough_creative_tab.data.CreativeTabValidation;
...
public final class CreativeTabReloadListener extends SimplePreparableReloadListener<CreativeTabReloadListener.Prepared> {
            ...
            for (Resource resource : entry.getValue()) {
                ...
                try (Reader reader = resource.openAsReader()) {
                    ...
                    if (isOwnedPack(source)) {
                        OneEnoughCreativeTabConstants.LOGGER.warn(
    ...
    private static boolean isEditorCustomTab(Identifier id) {
        return id.getNamespace().equals(OneEnoughCreativeTabConstants.MOD_ID)
