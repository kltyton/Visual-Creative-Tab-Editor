...
**可视化创造标签页编辑器**（Visual Creative Tab Editor）是一个面向 Minecraft 26.1.2 的创造标签页编辑 Mod，同时支持 Fabric 与 NeoForge。
...
| Mod 版本 | `2.1.0` |
| Minecraft | `26.1.2` |
| Fabric | Loader `0.19.3+`，需要 Fabric API；当前使用 `0.155.3+26.1.2` 构建和验证 |
| NeoForge | `26.1.2.109+` |
| Java | `25+` |
| 安装位置 | 单人游戏安装在客户端；多人游戏支持仅客户端本地编辑，也支持双端共享编辑 |
| 配置文件 | 当前没有独立配置文件 |
...
| --- | --- | --- | --- |
| `26.1.2` | [`26.1.2`](https://github.com/kltyton/Visual-Creative-Tab-Editor/tree/26.1.2) | Fabric、NeoForge | `25+` |
