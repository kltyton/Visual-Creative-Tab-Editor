...
**可视化创造标签页编辑器**（Visual Creative Tab Editor）是一个面向 Minecraft 1.21.1 的创造标签页编辑 Mod，同时支持 Fabric、NeoForge 与 Forge。
...
| Mod 版本 | `2.1.0` |
| Minecraft | `1.21.1` |
| Fabric | Loader `0.16.9+`，需要 Fabric API；项目配置版本为 `0.109.0+1.21.1` |
| NeoForge | `21.1.80+` |
| Forge | `52.0.28+` |
| Java | `21+` |
